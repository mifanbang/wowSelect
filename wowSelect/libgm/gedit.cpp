...
GEdit::GEdit(GUI *parent) : GUI(parent) {
	initGUI();
}
...
void GEdit::initGUI() {
	...
	createGUI(WS_EX_CLIENTEDGE, _T("Edit"), NULL, WS_CHILD | WS_VISIBLE | WS_TABSTOP | ES_AUTOHSCROLL, &geometry, (HMENU)GUI::GUIManager.getGUICounter(), NULL);
